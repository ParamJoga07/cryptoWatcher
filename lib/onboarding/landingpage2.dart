...
void main() {
  runApp(const DayAndNightSwitch());
}

const dayColor = Color(0xFFd56352);
const nightColor = Color(0xFF1e2230);

class DayAndNightSwitch extends StatelessWidget {
  const DayAndNightSwitch({super.key});
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Image.asset(
                val
                    ? 'lib/assets/mountain2_night.png'
                    : 'lib/assets/mountain2.png',
                fit: BoxFit.cover,
              ),
            ),
            Positioned(
              ...
              child: Image.asset(
                val
                    ? 'lib/assets/mountain_night.png'
                    : 'lib/assets/mountain1.png',
                fit: BoxFit.cover,
              ),
            ),
            AnimatedBuilder(
            ...
            Center(
              child: DayNightSwitch(
                value: val,
                moonImage: const AssetImage('lib/assets/moon.png'),
                onChanged: (value) {
                  setState(() {
                    val = value;
                  });
